OC.L10N.register(
    ...
    "Official apps are developed by and within the ownCloud community. They offer functionality central to ownCloud and are ready for production use." : "官方应用是由 sureCloud 社区开发。他们提供 sureCloud 的功能核心并准备用于生产。",
    ...
    "Encryption alone does not guarantee security of the system. Please see ownCloud documentation for more information about how the encryption app works, and the supported use cases." : "加密本身并不能保证系统的安全性。请参阅sureCloud文档有关加密应用程序是如何工作和支持用例的详细信息等。",
    ...
    "You need to migrate your encryption keys from the old encryption (sureCloud <= 8.0) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "你需要升级你的加密密钥 (旧版 sureCloud <= 8.0) 。 请在应用中启用 \\\"Default encryption module\\\" 并运行 'occ encryption:migrate'",
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one." : "您需要将加密密钥从旧版(sureCloud<=8.0)迁移到新版。",
    ...
    "This app has no minimum ownCloud version assigned. This will be an error in ownCloud 11 and later." : "这个程序没有指定最低的sureCloud版本。这是在sureCloud11之后版本的错误。",
    "This app has no maximum ownCloud version assigned. This will be an error in ownCloud 11 and later." : "这个程序没有指定最高的sureCloud版本。这是在sureCloud11之后版本的错误。",
    ...
    "Language" : "语言",
    "Help translate" : "帮助翻译",
    "These are the web, desktop and mobile clients currently logged in to your ownCloud." : "当前登陆的客户端、移动设备及浏览器",    
    "An app password is a passcode that gives an app or device permissions to access your %s account." : "登陆云盘的移动设备密码",
    "Create new app password" : "创建新的APP密码",
    "Name" : "名称",
    "Username" : "用户名",
