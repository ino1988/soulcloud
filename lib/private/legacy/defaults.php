...
class OC_Defaults {
	...
	function __construct() {
		...
		$this->defaultEntity = 'surecloud'; /* e.g. company name, used for footers and copyright notices */
		$this->defaultName = 'surecloud'; /* short name, used when referring to the software */
		$this->defaultTitle = 'surecloud'; /* can be a longer name, for titles */
		$this->defaultBaseUrl = 'http://www.lhchina.cn';
		$this->defaultSyncClientUrl = 'http://www.lhchina.cn';
		$this->defaultiOSClientUrl = 'http://www.lhchina.cn';
		$this->defaultiTunesAppId = '543672169';
		$this->defaultAndroidClientUrl = 'http://www.lhchina.cn';
		$this->defaultDocBaseUrl = 'http://www.lhchina.cn';
