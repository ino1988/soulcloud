OC.L10N.register(
    ...
    "This server has no working Internet connection. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "此服务器上没有可用的因特网连接. 这意味着某些特性将无法工作，例如挂载外部存储器, 提醒更新或安装第三方应用等. 从远程访问文件和发送提醒电子邮件也可能无法工作. 如果你想要sureloud的所有特性, 我们建议启用此服务器的因特网连接.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing ownCloud from a trusted proxy. If you are not accessing ownCloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to ownCloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "反向代理头配置不正确，或者您正从一个受信任的代理访问sureCloud。如果你不是通过受信任的代理访问 sureCloud，这将引发一个安全问题，可能由于 sureCloud IP 地址可见导致欺骗攻击。更多信息可以查看我们的 <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">文档</a>。",
    ...
    "Share" : "分享",
    "Share with people on other ownClouds using the syntax username@example.com/owncloud" : "使用语法 username@example.com/surecloud 分享给其他 sureCloud 上的用户",
    ...
    "The update was unsuccessful. Please report this issue to the <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">ownCloud community</a>." : "更新不成功。请汇报将此问题汇报给  <a href=\"https://github.com/owncloud/core/issues\" target=\"_blank\">sureCloud 社区</a>。",
    "The update was successful. There were warnings." : "更新成功。有警告。",
    "The update was successful. Redirecting you to ownCloud now." : "更新成功。正在重定向至 sureCloud。",
